...
const SENDGRID_FROM_EMAIL = Deno.env.get('SENDGRID_FROM_EMAIL') || 'noreply@mallettico.fr';
const SENDGRID_FROM_NAME = Deno.env.get('SENDGRID_FROM_NAME') || 'Mallettico';
  ...
  <center style="width: 100%; background-color: #f4f4f5; padding: 24px 0;">
    <div class="email-container" style="border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
      ...
      <div class="email-footer">
        <p>Cet email a été envoyé automatiquement par Mallettico.</p>
