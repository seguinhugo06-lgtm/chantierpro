 ...
 *
 * Updated: January 2026 - Realistic dates
 */
...
export const DEMO_CATALOGUE = [
  ...
  { id: 'cat6', nom: 'Main d\'œuvre pose carrelage', prix: 45, prixAchat: 0, unite: 'm²', categorie: 'Main d\'œuvre', favori: true },
  { id: 'cat7', nom: 'Main d\'œuvre peinture', prix: 25, prixAchat: 0, unite: 'm²', categorie: 'Main d\'œuvre', favori: true },
  { id: 'cat8', nom: 'Sac de ciment 35kg', prix: 12, prixAchat: 7, unite: 'sac', categorie: 'Maçonnerie', favori: false }
];

export const DEMO_DEVIS = [
  { id: 'd1', numero: 'DEV-2026-001', type: 'devis', client_id: 'c1', chantier_id: 'ch1', date: '2026-01-05', validite: 30, statut: 'accepte', tvaRate: 10, lignes: [{ id: 'l1', description: 'Dépose cuisine existante', quantite: 1, unite: 'forfait', prixUnitaire: 800, montant: 800 }, { id: 'l2', description: 'Pose carrelage sol', quantite: 18, unite: 'm²', prixUnitaire: 45, montant: 810 }, { id: 'l3', description: 'Plomberie cuisine', quantite: 1, unite: 'forfait', prixUnitaire: 1200, montant: 1200 }, { id: 'l4', description: 'Électricité', quantite: 1, unite: 'forfait', prixUnitaire: 950, montant: 950 }], total_ht: 3760, tva: 376, total_ttc: 4136 },
  { id: 'd2', numero: 'DEV-2026-002', type: 'devis', client_id: 'c2', chantier_id: 'ch2', date: '2026-01-15', validite: 30, statut: 'accepte', tvaRate: 10, lignes: [{ id: 'l1', description: 'Dépose salle de bain', quantite: 1, unite: 'forfait', prixUnitaire: 600, montant: 600 }, { id: 'l2', description: 'Pose douche italienne', quantite: 1, unite: 'forfait', prixUnitaire: 2500, montant: 2500 }, { id: 'l3', description: 'Carrelage mural', quantite: 25, unite: 'm²', prixUnitaire: 55, montant: 1375 }], total_ht: 4475, tva: 447.5, total_ttc: 4922.5 },
  { id: 'd3', numero: 'FAC-2025-015', type: 'facture', client_id: 'c3', chantier_id: 'ch3', date: '2025-12-20', statut: 'payee', tvaRate: 10, lignes: [{ id: 'l1', description: 'Peinture T3 complet', quantite: 85, unite: 'm²', prixUnitaire: 25, montant: 2125 }], total_ht: 2125, tva: 212.5, total_ttc: 2337.5 },
  { id: 'd4', numero: 'DEV-2026-003', type: 'devis', client_id: 'c4', chantier_id: 'ch4', date: '2026-01-25', validite: 60, statut: 'brouillon', tvaRate: 20, lignes: [{ id: 'l1', description: 'Gros œuvre extension', quantite: 40, unite: 'm²', prixUnitaire: 450, montant: 18000 }, { id: 'l2', description: 'Toiture', quantite: 45, unite: 'm²', prixUnitaire: 180, montant: 8100 }, { id: 'l3', description: 'Menuiseries extérieures', quantite: 1, unite: 'forfait', prixUnitaire: 6500, montant: 6500 }], total_ht: 32600, tva: 6520, total_ttc: 39120 },
  { id: 'd5', numero: 'DEV-2026-004', type: 'devis', client_id: 'c5', chantier_id: 'ch5', date: '2026-01-02', validite: 30, statut: 'accepte', tvaRate: 10, lignes: [{ id: 'l1', description: 'Rénovation studio complète', quantite: 25, unite: 'm²', prixUnitaire: 280, montant: 7000 }, { id: 'l2', description: 'Électricité', quantite: 1, unite: 'forfait', prixUnitaire: 1500, montant: 1500 }], total_ht: 8500, tva: 850, total_ttc: 9350 },
  { id: 'd6', numero: 'DEV-2026-005', type: 'devis', client_id: 'c6', chantier_id: 'ch6', date: '2026-01-20', validite: 45, statut: 'envoye', tvaRate: 20, lignes: [{ id: 'l1', description: 'Cloisons bureau', quantite: 30, unite: 'm²', prixUnitaire: 180, montant: 5400 }, { id: 'l2', description: 'Électricité complète', quantite: 1, unite: 'forfait', prixUnitaire: 4200, montant: 4200 }, { id: 'l3', description: 'Climatisation', quantite: 2, unite: 'unité', prixUnitaire: 1200, montant: 2400 }], total_ht: 12000, tva: 2400, total_ttc: 14400 },
  { id: 'd7', numero: 'FAC-2025-012', type: 'facture', client_id: 'c7', chantier_id: 'ch7', date: '2025-12-10', statut: 'payee', tvaRate: 10, lignes: [{ id: 'l1', description: 'Terrasse bois composite', quantite: 30, unite: 'm²', prixUnitaire: 180, montant: 5400 }, { id: 'l2', description: 'Structure porteuse', quantite: 1, unite: 'forfait', prixUnitaire: 1400, montant: 1400 }], total_ht: 6800, tva: 680, total_ttc: 7480 },
  { id: 'd8', numero: 'DEV-2026-006', type: 'devis', client_id: 'c8', chantier_id: 'ch8', date: '2026-01-10', validite: 30, statut: 'accepte', tvaRate: 10, lignes: [{ id: 'l1', description: 'Rénovation plomberie complète', quantite: 1, unite: 'forfait', prixUnitaire: 8500, montant: 8500 }, { id: 'l2', description: 'Réfection électrique', quantite: 1, unite: 'forfait', prixUnitaire: 9500, montant: 9500 }, { id: 'l3', description: 'Peinture et finitions', quantite: 95, unite: 'm²', prixUnitaire: 65, montant: 6175 }, { id: 'l4', description: 'Sols', quantite: 75, unite: 'm²', prixUnitaire: 51, montant: 3825 }], total_ht: 28000, tva: 2800, total_ttc: 30800 },
  { id: 'd9', numero: 'FAC-2026-001', type: 'facture', client_id: 'c5', chantier_id: 'ch5', date: '2026-01-22', statut: 'envoye', tvaRate: 10, facture_type: 'acompte', devis_source_id: 'd5', lignes: [{ id: 'l1', description: 'Acompte 40% - Rénovation studio', quantite: 1, unite: 'forfait', prixUnitaire: 3400, montant: 3400 }], total_ht: 3400, tva: 340, total_ttc: 3740 }
];

export const DEMO_DEPENSES = [
  { id: 'dep1', chantierId: 'ch1', description: 'Carrelage cuisine', montant: 520, categorie: 'Matériaux', date: '2026-01-12' },
  { id: 'dep2', chantierId: 'ch1', description: 'Robinetterie', montant: 380, categorie: 'Matériaux', date: '2026-01-14' },
  { id: 'dep3', chantierId: 'ch1', description: 'Électroménager', montant: 1850, categorie: 'Matériaux', date: '2026-01-18' },
  { id: 'dep4', chantierId: 'ch2', description: 'Receveur douche', montant: 450, categorie: 'Matériaux', date: '2026-01-22' },
  { id: 'dep5', chantierId: 'ch2', description: 'Carrelage mural', montant: 680, categorie: 'Matériaux', date: '2026-01-23' },
  { id: 'dep6', chantierId: 'ch3', description: 'Peinture + apprêt', montant: 320, categorie: 'Matériaux', date: '2025-12-05' },
  { id: 'dep7', chantierId: 'ch5', description: 'Électricité - câbles', montant: 280, categorie: 'Matériaux', date: '2026-01-08' },
  { id: 'dep8', chantierId: 'ch5', description: 'Plomberie - raccords', montant: 195, categorie: 'Matériaux', date: '2026-01-10' },
  { id: 'dep9', chantierId: 'ch7', description: 'Lames terrasse composite', montant: 2400, categorie: 'Matériaux', date: '2025-11-20' },
  { id: 'dep10', chantierId: 'ch7', description: 'Plots réglables', montant: 580, categorie: 'Matériaux', date: '2025-11-18' },
  { id: 'dep11', chantierId: 'ch8', description: 'Tuyaux cuivre', montant: 890, categorie: 'Matériaux', date: '2026-01-18' },
  { id: 'dep12', chantierId: 'ch8', description: 'Tableau électrique', montant: 1250, categorie: 'Matériaux', date: '2026-01-20' },
  { id: 'dep13', chantierId: 'ch8', description: 'Peinture premium', montant: 780, categorie: 'Matériaux', date: '2026-01-22' }
];
...
export const DEMO_POINTAGES = [
  ...
  { id: 'p6', employeId: 'e1', chantierId: 'ch2', date: '2026-01-22', heures: 8, approuve: true },
  { id: 'p7', employeId: 'e3', chantierId: 'ch2', date: '2026-01-22', heures: 6, approuve: true },
  { id: 'p8', employeId: 'e1', chantierId: 'ch3', date: '2025-12-05', heures: 8, approuve: true, verrouille: true },
  { id: 'p9', employeId: 'e2', chantierId: 'ch3', date: '2025-12-05', heures: 8, approuve: true, verrouille: true },
  { id: 'p10', employeId: 'e2', chantierId: 'ch3', date: '2025-12-06', heures: 8, approuve: true, verrouille: true },
  { id: 'p11', employeId: 'e1', chantierId: 'ch5', date: '2026-01-06', heures: 8, approuve: true },
  { id: 'p12', employeId: 'e3', chantierId: 'ch5', date: '2026-01-06', heures: 8, approuve: true },
  { id: 'p13', employeId: 'e1', chantierId: 'ch5', date: '2026-01-07', heures: 8, approuve: true },
  { id: 'p14', employeId: 'e4', chantierId: 'ch5', date: '2026-01-08', heures: 6, approuve: true },
  { id: 'p15', employeId: 'e1', chantierId: 'ch7', date: '2025-11-18', heures: 8, approuve: true, verrouille: true },
  { id: 'p16', employeId: 'e2', chantierId: 'ch7', date: '2025-11-18', heures: 8, approuve: true, verrouille: true },
  { id: 'p17', employeId: 'e1', chantierId: 'ch7', date: '2025-11-19', heures: 8, approuve: true, verrouille: true },
  { id: 'p18', employeId: 'e2', chantierId: 'ch7', date: '2025-11-19', heures: 8, approuve: true, verrouille: true },
  { id: 'p19', employeId: 'e1', chantierId: 'ch8', date: '2026-01-16', heures: 8, approuve: true },
  { id: 'p20', employeId: 'e2', chantierId: 'ch8', date: '2026-01-16', heures: 8, approuve: true },
  { id: 'p21', employeId: 'e4', chantierId: 'ch8', date: '2026-01-17', heures: 8, approuve: false },
  { id: 'p22', employeId: 'e1', chantierId: 'ch8', date: '2026-01-17', heures: 8, approuve: false }
];
