        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl border p-6">
            ...
            <div className="flex justify-center gap-4">
              {!chrono.running ? <button onClick={startChrono} className="px-8 py-3 text-white rounded-xl text-lg" style={{background: couleur}}>▶️ Démarrer</button> : <button onClick={() => { const note = prompt('Note de fin (optionnel):'); stopChrono(note || ''); }} className="px-8 py-3 bg-red-500 text-white rounded-xl text-lg">⏹️ Arrêter</button>}
            </div>
          </div>
          <div className="bg-white rounded-2xl border p-6">
            ...
            {equipe.map(e => (
              <div key={e.id} className="bg-white rounded-2xl border p-5">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <button onClick={() => deleteEmploye(e.id)} className="text-red-400 hover:text-red-600">🗑️</button>
                </div>
