      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <a href="/" className="flex items-center gap-2 text-slate-900 hover:text-orange-500 transition-colors">
            ...
            <span className="text-lg font-bold">Mallettico</span>
          </a>
        ...
        <div className="prose prose-slate max-w-none space-y-8">
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              Les présentes Conditions Générales d'Utilisation (CGU) régissent l'accès et l'utilisation du service Mallettico, accessible à l'adresse mallettico.fr. En créant un compte ou en utilisant le service, l'utilisateur accepte sans réserve les présentes CGU.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              Mallettico est un logiciel en ligne (SaaS) de gestion de chantier destiné aux artisans et entreprises du BTP. Il permet notamment :
            </p>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              Mallettico propose plusieurs formules d'abonnement, dont une offre gratuite avec des fonctionnalités limitées. Les tarifs des offres payantes sont indiqués sur la page Tarifs du site et peuvent être modifiés à tout moment. Les utilisateurs abonnés seront informés de tout changement de tarif au moins 30 jours avant son application.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              Mallettico fournit le service "en l'état". L'éditeur ne garantit pas l'absence d'erreurs ou d'interruptions. L'utilisateur est seul responsable de la vérification des montants, calculs et informations générées par le service, notamment en matière de devis, factures et obligations légales.
            </p>
            <p className="text-slate-600 leading-relaxed mt-2">
              Mallettico ne se substitue pas à un expert-comptable et ne fournit pas de conseil fiscal ou juridique.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              Mallettico s'efforce de maintenir le service accessible 24h/24, 7j/7, mais ne peut garantir une disponibilité permanente. Des interruptions pour maintenance pourront avoir lieu, si possible en dehors des heures ouvrées.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              L'utilisateur peut résilier son compte à tout moment depuis les paramètres du service. Mallettico se réserve le droit de suspendre ou résilier un compte en cas de violation des présentes CGU, après notification préalable.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              Pour toute question relative aux présentes CGU, vous pouvez nous contacter à : <a href="mailto:contact@mallettico.fr" className="text-orange-500 hover:underline">contact@mallettico.fr</a>
            </p>
          </section>
        </div>
