        ...
        <div className="prose prose-slate max-w-none space-y-8">
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              [Adresse complète]<br />
              Contact DPO : contact@mallettico.fr
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              Dans le cadre de l'utilisation du service Mallettico, nous collectons les données suivantes :
            </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-slate-600 space-y-1 mt-2">
              <li>Fourniture et fonctionnement du service Mallettico</li>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              Mallettico met en œuvre des mesures techniques et organisationnelles appropriées pour protéger vos données :
            </p>
            <ul className="list-disc pl-6 text-slate-600 space-y-1 mt-2">
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed mt-3">
              Pour exercer vos droits, contactez-nous à : <a href="mailto:contact@mallettico.fr" className="text-orange-500 hover:underline">contact@mallettico.fr</a>
            </p>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              Mallettico utilise uniquement des cookies strictement nécessaires au fonctionnement du service :
            </p>
            <ul className="list-disc pl-6 text-slate-600 space-y-1 mt-2">
