    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className={`fixed bottom-[104px] md:bottom-6 right-4 z-40 items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-full shadow-lg transition-all duration-300 hover:scale-110 active:scale-95 ${inputFocused ? 'hidden sm:flex' : 'flex'}`}
