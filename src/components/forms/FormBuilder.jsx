...
const TEMPLATES = [
  {
    ...
    categorie: 'Réception',
    champs: [
      { id: '1', type: 'texte', label: 'Chantier / Adresse', obligatoire: true },
      { id: '2', type: 'texte', label: 'Client (maître d\'ouvrage)', obligatoire: true },
      { id: '3', type: 'date', label: 'Date de réception', obligatoire: true },
      { id: '4', type: 'checkbox', label: 'Travaux conformes au devis', obligatoire: true },
      { id: '5', type: 'checkbox', label: 'Locaux en état de propreté', obligatoire: false },
      { id: '6', type: 'selection', label: 'Réception', obligatoire: true, options: ['Sans réserve', 'Avec réserves', 'Refusée'] },
      { id: '7', type: 'remarque', label: 'Réserves constatées (le cas échéant)', obligatoire: false },
      { id: '8', type: 'date', label: 'Date limite de levée des réserves', obligatoire: false },
      { id: '9', type: 'photo', label: 'Photos de réception', obligatoire: false },
      { id: '10', type: 'remarque', label: 'Observations complémentaires', obligatoire: false },
      { id: '11', type: 'signature', label: 'Signature du client', obligatoire: true },
      { id: '12', type: 'signature', label: 'Signature de l\'entreprise', obligatoire: true },
    ],
  },
  {
    ...
    champs: [
      { id: '1', type: 'texte', label: 'Client / Lieu d\'intervention', obligatoire: true },
      { id: '2', type: 'texte', label: 'Technicien(s)', obligatoire: true },
      { id: '3', type: 'date', label: 'Date d\'intervention', obligatoire: true },
      { id: '4', type: 'selection', label: 'Type d\'intervention', obligatoire: true, options: ['Dépannage', 'Installation', 'Mise en service', 'Maintenance préventive', 'Maintenance corrective', 'SAV / Garantie', 'Diagnostic', 'Autre'] },
      { id: '5', type: 'selection', label: 'Urgence', obligatoire: false, options: ['Normale', 'Urgente', 'Critique'] },
      { id: '6', type: 'remarque', label: 'Description des travaux réalisés', obligatoire: true },
      { id: '7', type: 'texte', label: 'Matériaux et pièces utilisés', obligatoire: false },
      { id: '8', type: 'nombre', label: 'Quantité pièces', obligatoire: false },
      { id: '9', type: 'photo', label: 'Photos avant intervention', obligatoire: false },
      { id: '10', type: 'photo', label: 'Photos après intervention', obligatoire: false },
      { id: '11', type: 'nombre', label: 'Durée intervention (h)', obligatoire: true },
      { id: '12', type: 'nombre', label: 'Temps de déplacement (h)', obligatoire: false },
      { id: '13', type: 'selection', label: 'État de l\'installation', obligatoire: true, options: ['Fonctionnel', 'Partiellement fonctionnel', 'Hors service', 'En attente de pièce'] },
      { id: '14', type: 'remarque', label: 'Observations / Suite à donner', obligatoire: false },
      { id: '15', type: 'checkbox', label: 'Intervention terminée', obligatoire: false },
