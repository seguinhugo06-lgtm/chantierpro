              ...
              {filtered.map(item => {
                ...
                return (
                  <tr key={item.id} className="border-b last:border-0 hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3 text-center"><button onClick={() => startEdit(item)} className="text-slate-400 hover:text-slate-600 mr-2">✏️</button><button onClick={() => deleteItem(item.id)} className="text-red-400 hover:text-red-600">🗑️</button></td>
                  </tr>
                );
              })}
            </tbody>
