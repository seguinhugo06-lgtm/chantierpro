...
export default function Catalogue({ catalogue, setCatalogue, couleur, isDark }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {filtered.length === 0 ? <div className={`rounded-2xl border ${cardBg}`} p-12 text-center"><p className="text-5xl mb-4"></p><p className="text-slate-500">Catalogue vide</p></div> : (
