          ...
          {!modeDiscret ? (
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={stats.caParMois}>
                ...
                <Tooltip formatter={(v) => [`${v.toLocaleString()} â‚¬`, 'CA']} contentStyle={{ borderRadius: 12, border: 'none', boxShadow: '0 4px 20px rgba(0,0,0,0.15)', background: isDark ? '#1e293b' : '#fff', color: isDark ? '#fff' : '#000' }} />
