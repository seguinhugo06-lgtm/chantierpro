        ...
        <div className={`flex items-center justify-around px-1 py-1 border-t ${isDark ? 'bg-slate-900/95 border-slate-700 backdrop-blur' : 'bg-white/95 border-slate-200 backdrop-blur'}`}>
          {[
            ...
            <button
              ...
              className={`flex flex-col items-center justify-center py-1.5 px-3 rounded-lg min-h-[44px] transition-colors ${page === item.id ? 'text-white' : isDark ? 'text-slate-400' : 'text-slate-500'}`}
